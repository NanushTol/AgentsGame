...
public class GnobTypeDropdown : MonoBehaviour
{
    ...
    {
        AgentType = selectObjectScript.SelectedAgent.GetComponent<Agent>().MissionInLife;
    ...
    public void ChangeGnobType()
    {
        ...
        selectObjectScript.SelectedAgent.GetComponent<Agent>().MissionInLife = AgentType;
    }
}
